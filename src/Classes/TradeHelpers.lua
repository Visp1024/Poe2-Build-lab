...
-- Lua 5.4 (NLua host) rejects "%x" in a gsub REPLACEMENT string unless x is a digit
-- or "%"; LuaJIT silently passed it through. Escape every literal "%" as "%%" so the
-- replacement still renders the pattern "%d+%.?%d*".
